// $Id: uc_donate.js,v 1.1.4.4 2009/06/08 15:16:21 greenskin Exp $

Drupal.Donate = Drupal.Donate || {};

Drupal.behaviors.donate = function() {
...
Drupal.Donate.update = function() {
  ...
  if (total != 0) {
    $('h4#donate-total').highlightFade({color: 'yellow', speed:2000, iterator: 'sinusoidal'});
  }
}
